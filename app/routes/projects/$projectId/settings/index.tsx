...
import { z } from 'zod';
import { Project, updateProject, findProjectMembersById, transferProject } from '~/models/project.server';
...
const TransferDialog: React.FC<{
  ...
  return <Modal size={'lg'} isOpen={isOpen} onClose={onClose}>
    ...
    <ModalContent>
      ...
      <ModalCloseButton />
      <ModalBody pb={6} as={ValidatedForm} replace method="patch" resetAfterSubmit validator={transferValidator}>
        ...
        <Center mt={10}>
          <FormSubmitButton colorScheme="red" isDisabled={isDisabled} name="_action" value="transferProject" ml={3}>
  ...
  >
    ...
    <ModalContent>
      ...
      <ModalBody pb={10}>
        ...
        <Center mt={10} as={ValidatedForm} replace method="patch" resetAfterSubmit validator={deleteValidator}>
  ...
  useEffect(() => {
    if (transition.state === 'loading') {
      ...
      if (action === 'renameProject') {
        ...
        transition.type === 'actionRedirect' && toast({
